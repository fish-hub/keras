...
def creat_net(train_generator,validation_generator,batch_size,image_lengh,image_width):
    ...
    model = Sequential()
    model.add(Conv2D(filters=32, kernel_size=(5,5), padding='same', input_shape=(image_lengh,image_width,3), data_format='channels_last', kernel_initializer=initializers.he_normal()))
