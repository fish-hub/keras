...
if __name__ =="__main__":
    ...
    #生成图片
    generator_train,generator_test = image_process(batch_size=32,train_dir=train_dir,test_dir=test_dir,image_lengh=image_lengh,image_width=image_width)
    print("图片处理完成")
    #构建网络+训练
    creat_net(generator_train,generator_test,batch_size=32,image_lengh=image_lengh,image_width=image_width)
    print("结束")