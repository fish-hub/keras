...
def creat_net(train_generator,validation_generator,batch_size,image_lengh,image_width):
    ...
    base_model = applications.InceptionV3(weights='imagenet', include_top=False,input_shape= (image_lengh,image_width,3))
    ...
    model.fit_generator(train_generator, epochs=100, steps_per_epoch=1707//batch_size,validation_data=validation_generator,
...
if __name__ =="__main__":
    ...
    #得到图片尺寸
    image_lengh,image_width = 229, 229
    #生成图片
